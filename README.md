...
- On the refreshed 4-case set, `MarkItDown`, `Crawl4AI`, `Scrapling stealthy fetch`, and the generic `Scrapy` spider all score 100%: the current cases separate cookie-wall and JS handling, not top-tier fetchers. `Firecrawl scrape` scores 88%.
