...
- Browser automation is scored on five investigative workflows: Companies House filing history, OpenSanctions entity screening, Wikidata entity identity, OpenStreetMap place lookup, and a paginated Wikidata search that only scores fully on the third results page (added 2026-07-03 to break the all-tools-at-100% tie; it immediately split the field: dev-browser and browser-use CLI 100%, Playwright script and Stagehand 40%).
